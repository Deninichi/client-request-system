...
class CRS {
	...
	public function __construct() {
		if ( defined( 'CRS_VERSION' ) ) {
			$this->version = CRS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'crs';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-crs-loader.php';
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter('body_class', $plugin_public, 'crs_add_body_classes');
